...
static const Rule rules[] = {
	...
	// 1:term
	{ "htop",               NULL,       NULL,            1 << 0,       False,        2 },
	{ "xterm-monitor-1",    NULL,       NULL,            0,            False,        3 },
	// 2:dev
	{ "jetbrains-idea",     NULL,       NULL,            1 << 1,       False,        3 },
	{ "jetbrains-phpstorm", NULL,       NULL,            1 << 1,       False,        3 },
	{ "jetbrains-pycharm",  NULL,       NULL,            1 << 1,       False,        3 },
	{ "Fritzing",           NULL,       NULL,            1 << 1,       False,        3 },
	{ "java-lang-Thread",   NULL,       NULL,            1 << 1,       True,         3 },
	// 3:web
...
static const char *volmaxcmd[]      = { "volume-control", "-m", "--dzen", NULL };
...
static const Key keys[] = {
	...
	{ ControlMask,                  0xffab,    spawn,          {.v = volmaxcmd } },
